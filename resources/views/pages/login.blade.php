    ...
    <section class="form signup">
        ...
        <form action="{{url('doLogin')}}" method="post"> 
            ...
            @enderror
                ...
                <input type="text" name="email" value="{{ (Cookie::get('remember') == 'remembered') ? Cookie::get('email') : '' }}" placeholder="Enter your email">
            </div>
            <div class="field input">
            @error('password')
            <p>{{ showError($message) }}</p>
            @enderror
                ...
                <input type="password" id="pass_log_id" name="password" value="{{ (Cookie::get('remember') == 'remembered') ? Cookie::get('password') : '' }}" placeholder="Enter your password">
